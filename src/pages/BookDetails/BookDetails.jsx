...
const BookDetails = () => {
    ...
    return (
        <div className="container mx-auto">
            <h2 className="text-lg font-semibold text-gray-700 capitalize dark:text-white mb-4 px-4 md:px-0">Book Details</h2>
            <div className="md:flex items-center gap-8">
                <div className="overflow-hidden md:w-2/3 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <img className="object-cover w-full h-64 px-4 md:px-0" src={bookimage} alt="Article" />
                    <div className="p-6">
                        <div>
                ...
                <div className="p-6 bg-white rounded-md shadow-md dark:bg-gray-800">
                    ...
                    <form onSubmit={handleBorrowedBook}>
                        <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            ...
                            <div>
                                <label className="text-gray-700 dark:text-gray-200 block">Borrowed Date</label>
                            ...
                            <div className="">
                                <label className="text-gray-700 dark:text-gray-200 block">Return Date</label>
